...
The arm64 build is ad-hoc signed, not Developer ID signed or notarized. macOS may require Control-click → Open, or **Privacy & Security → Open Anyway**, on first launch. Verify the download against `SHA256SUMS.txt` before bypassing Gatekeeper.
