...
#if os(macOS)
dependencies.append(.package(path: "Packages/PitchdogStudioUI"))
...
targets += [
    ...
    .executableTarget(name: "GalileoGallery", dependencies: ["GalileoNative", "GalileoCore", .product(name: "PitchdogStudioUI", package: "PitchdogStudioUI")]),
