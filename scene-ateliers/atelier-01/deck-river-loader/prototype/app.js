(function () {
  ...
  const CONFIG = {"evaluatorGlobal":"ChapterRevealEvaluator","title":"Deck River \u2014 Chapter Reveal","studyDurationMs":null,"paceMs":null,"finite":true,"rotatesCards":false,"hasTargetControl":true,"controls":[{"id":"frameScale","label":"Corridor frame size","min":0.16,"max":0.38,"step":0.01,"unit":"\u00d7 short axis","digits":2},{"id":"depthSpacing","label":"Depth spacing","min":0.65,"max":1.6,"step":0.01,"unit":"world scale","digits":2},{"id":"laneSpread","label":"Corridor width","min":1.4,"max":4.4,"step":0.05,"unit":"world units","digits":2},{"id":"nearPass","label":"Camera clearance","min":0.9,"max":2.4,"step":0.05,"unit":"world units","digits":2},{"id":"arrivalScale","label":"Arrival size","min":0.42,"max":0.82,"step":0.01,"unit":"\u00d7 short axis","digits":2}]};
