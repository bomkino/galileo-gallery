# Browser evidence — Deck River — Chapter Reveal
...
- Decoded frames: `271`.
- Final packet end: `9.084 s`.
- Measured average: `29.83 fps` against a nominal 30 fps canvas stream.
- File size: `1122707` bytes.
...
- `chapter-landmarks/` — all named finite phrase boundaries plus the terminal pose.
...
- fully transparent pixels: `476,511`
- partial-alpha pixels: `1,374`
- opaque pixels: `40,515`
