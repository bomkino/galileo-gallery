# Browser evidence — Deck River — Continuous
...
- Decoded frames: `260`.
- Final packet end: `8.667 s`.
- Measured average: `30.00 fps` against a nominal 30 fps canvas stream.
- File size: `1273110` bytes.
...
- fully transparent pixels: `479,611`
- partial-alpha pixels: `1,446`
- opaque pixels: `37,343`
