(function () {
  ...
  const CONFIG = {"evaluatorGlobal":"DeckRiverEvaluator","title":"Deck River \u2014 Continuous","studyDurationMs":8400,"paceMs":1050,"finite":false,"rotatesCards":false,"hasTargetControl":false,"controls":[{"id":"frameScale","label":"Frame size","min":0.18,"max":0.48,"step":0.01,"unit":"\u00d7 short axis","digits":2},{"id":"depthSpacing","label":"Depth spacing","min":0.65,"max":1.6,"step":0.01,"unit":"world scale","digits":2},{"id":"laneSpread","label":"Corridor width","min":1.4,"max":4.2,"step":0.05,"unit":"world units","digits":2},{"id":"nearPass","label":"Camera clearance","min":0.9,"max":2.4,"step":0.05,"unit":"world units","digits":2},{"id":"visibleDepth","label":"Corridor length","min":7,"max":18,"step":0.25,"unit":"world units","digits":2}]};
