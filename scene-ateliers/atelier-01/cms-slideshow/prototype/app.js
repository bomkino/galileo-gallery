(function () {
  ...
  const CONFIG = {"evaluatorGlobal":"QuietCarouselEvaluator","title":"Quiet Carousel","studyDurationMs":8000,"paceMs":1000,"finite":false,"rotatesCards":false,"hasTargetControl":false,"controls":[{"id":"frameScale","label":"Frame size","min":0.24,"max":0.78,"step":0.01,"unit":"\u00d7 cross axis","digits":2},{"id":"gap","label":"Minimum gap","min":0,"max":240,"step":1,"unit":"dp @ 1080","digits":0},{"id":"focusDepth","label":"Focus depth","min":0,"max":0.24,"step":0.01,"unit":"fraction","digits":2}]};
