(function () {
  ...
  const CONFIG = {"evaluatorGlobal":"FilmstripRiverEvaluator","title":"Ribbon \u2014 Two-lane Filmstrip","studyDurationMs":8000,"paceMs":900,"finite":false,"rotatesCards":false,"hasTargetControl":false,"controls":[{"id":"frameScale","label":"Frame size","min":0.16,"max":0.36,"step":0.01,"unit":"\u00d7 cross axis","digits":2},{"id":"gap","label":"Minimum gap","min":0,"max":160,"step":1,"unit":"dp @ 1080","digits":0},{"id":"laneSeparation","label":"Lane separation","min":0.25,"max":0.58,"step":0.01,"unit":"\u00d7 cross axis","digits":2},{"id":"lanePhase","label":"Lane offset","min":0,"max":1,"step":0.01,"unit":"cycle","digits":2}]};
