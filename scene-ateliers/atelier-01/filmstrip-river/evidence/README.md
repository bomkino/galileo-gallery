# Browser evidence — Ribbon — Two-lane Filmstrip
...
- Decoded frames: `247`.
- Final packet end: `8.267 s`.
- Measured average: `29.88 fps` against a nominal 30 fps canvas stream.
- File size: `2134593` bytes.
...
- fully transparent pixels: `260,589`
- partial-alpha pixels: `4,847`
- opaque pixels: `252,964`
