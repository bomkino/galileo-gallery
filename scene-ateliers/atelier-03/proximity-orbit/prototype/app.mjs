...
const SCENE = {"slug":"proximity-orbit","fan":false,"defaultFixture":"seven","defaultTime":3240,"featuredKey":"featuredIndex","controls":[{"id":"orbitRadius","unit":"%"},{"id":"proximityStrength","unit":"%"},{"id":"pathProjection","unit":"%"},{"id":"cardSize","unit":"%"},{"id":"featuredIndex","unit":""}],"title":"Proximity Orbit","storyLabel":"Story featured source","inspectionWindow":false}
