...
const SCENE = {"slug":"dealers-fan","fan":true,"defaultFixture":"five","defaultTime":3610,"featuredKey":"spotlightIndex","controls":[{"id":"fanStep","unit":"°"},{"id":"pivotDepth","unit":"%"},{"id":"visibleWindow","unit":"cards"},{"id":"presentationLift","unit":"%"},{"id":"cardSize","unit":"%"},{"id":"spotlightIndex","unit":""}],"title":"Dealer’s Pick","storyLabel":"Story spotlight source","inspectionWindow":false}
