...
const SCENE = {"slug":"orbit-ring","fan":false,"defaultFixture":"six","defaultTime":4400,"featuredKey":"featuredIndex","controls":[{"id":"ringRadius","unit":"%"},{"id":"planeTilt","unit":"°"},{"id":"cardSize","unit":"%"},{"id":"featuredIndex","unit":""}],"title":"Calm Ring","storyLabel":"Story featured source","inspectionWindow":false}
