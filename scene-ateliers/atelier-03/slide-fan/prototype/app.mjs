...
const SCENE = {"slug":"slide-fan","fan":true,"defaultFixture":"five","defaultTime":1848,"featuredKey":"featuredIndex","controls":[{"id":"spreadAngle","unit":"°"},{"id":"hingeHeight","unit":"%"},{"id":"cardSize","unit":"%"},{"id":"featuredLift","unit":"%"},{"id":"paperBreath","unit":"%"},{"id":"featuredIndex","unit":""}],"title":"Open Fan","storyLabel":"Story featured source","inspectionWindow":true}
