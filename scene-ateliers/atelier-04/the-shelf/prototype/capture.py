...
def without_first_import(source: str) -> str:
    first_newline = source.find("\n")
    first_semicolon = source.find(";")
...
async def run() -> None:
    ...
    app = without_first_import((HERE / "app.mjs").read_text())
    ...
    async with async_playwright() as playwright:
        ...
        cases = [
            {
                "name": "canonical-collected-row.png", "fixture": "ordinary8", "canvas": "16:9",
                "time": 0.20, "runKind": "loop", "spotlight": "ordinary-004", "finale": "ordinary-008",
                "transparent": False, "reduced": False,
            },
            {
                "name": "spotlight-straighten-lift.png", "fixture": "ordinary8", "canvas": "16:9",
                "time": 0.60, "runKind": "finite", "spotlight": "ordinary-004", "finale": "ordinary-008",
                "transparent": False, "reduced": False,
            },
            {
                "name": "two-item-handoff.png", "fixture": "two", "canvas": "16:9",
                "time": 0.35, "runKind": "loop", "spotlight": "two-001", "finale": "two-002",
                "transparent": False, "reduced": False,
            },
            {
                "name": "portrait-many-bounded.png", "fixture": "many127", "canvas": "9:16",
                "time": 0.613, "runKind": "loop", "spotlight": "many-061", "finale": "many-127",
                "transparent": False, "reduced": False,
            },
            {
                "name": "alpha-transparent.png", "fixture": "mediaEdge", "canvas": "1:1",
                "time": 0.60, "runKind": "finite", "spotlight": "media-edge-004", "finale": "media-edge-009",
                "transparent": True, "reduced": False,
            },
        ]
        ...
        for case in cases:
            await page.evaluate(
                """caseData => {
                    ...
                    prototypeApi.setControl('direction', 'forward');
    ...
    alpha = {
        ...
        "minimalSceneGeometry": "one alpha-safe horizontal baseline",
    }
    ...
    receipt = {
        ...
        "limitations": [
            "Generated fixtures do not prove external source-pixel equality or Product media lifecycle.",
            "Stills/frame sequence do not constitute human motion/taste acceptance or Product export integration.",
        ],
    }
