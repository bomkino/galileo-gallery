...
const PUBLIC_MESSAGES = Object.freeze({
    ...
    unexpected_archive_entry: "This project archive contains files that are not declared by its manifest.",
    media_missing: "This project archive is missing declared media.",
    media_hash_mismatch: "A media file in this project does not match its recorded content hash.",
    media_signature_mismatch: "A media file in this project has the wrong or an unsupported format signature.",
    canvas_invalid: "This project's canvas intent is invalid.",
    scene_invalid: "This project's Scene intent is invalid.",
    look_invalid: "This project's Look intent is invalid.",
    timeline_invalid: "This project's visual Timeline intent is invalid.",
    audio_invalid: "This project's audio intent is invalid.",
